      ...
      <ScreenWrapper>
        ...
        >
          ...
          <Text style={styles.description}>
            Since 1997, KUCC has pioneered technological innovation and
            excellence at Kathmandu University. Over 1000 members engaged
          ...
          <View style={styles.execContainer}>
            {executives.map((exec, i) => (
              <View key={i} style={styles.execCard}>
                <Image
                  source={exec.image || defaultImage}
                  style={styles.execImage}
                />
